...
local NAME    = "ObfusQ";
local REVISION = "Roblox";
local VERSION = "v1.0";
local BY      = "quantum-dev";
...
return {
	...
	Revision = REVISION;
	-- Config Starts Here
	IdentPrefix = "__obfusq_qx7m_"; -- The Prefix used for Identifiers generated by OBFUSQ. NOTE: There should be no identifiers in the script to be obfuscated starting with that prefix, because that can lead to weird bugs
	
	-- Default to LuaU for Roblox compatibility
	DefaultLuaVersion = "LuaU";
